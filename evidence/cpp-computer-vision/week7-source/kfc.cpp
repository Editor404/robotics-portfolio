...
KImageGray KImageGray::BinaryDilate(const int& nType, int maskSize)
{
    KImageGray igOut = *this;
    ...
    if (maskSize == 3)
    {
        ...
        if (nType == _FOREGROUND)
        {
            for (int i = 1, ii = Row() - 2; ii; i++, ii--)
                ...
                {
                    if (_ppA[i][j] == 0)
                        if (_ppA[i-1][j-1] || _ppA[i-1][j] || _ppA[i-1][j+1] ||
                            _ppA[i][j-1] || _ppA[i][j+1] ||
                            _ppA[i+1][j-1] || _ppA[i+1][j] || _ppA[i+1][j+1])
                            igOut._ppA[i][j] = 255;
                }
        }
        else if (nType == _BACKGROUND)
        {
            for (int i = 1, ii = Row() - 2; ii; i++, ii--)
                ...
                {
                    if (_ppA[i][j])
                        if (_ppA[i-1][j-1] == 0 || _ppA[i-1][j] == 0 || _ppA[i-1][j+1] == 0 ||
                            _ppA[i][j-1] == 0 || _ppA[i][j+1] == 0 ||
                            _ppA[i+1][j-1] == 0 || _ppA[i+1][j] == 0 || _ppA[i+1][j+1] == 0)
                            igOut._ppA[i][j] = 0;
                }
        }
    }
        ...
        if(nType == _FOREGROUND)
            {
                for(int i = 2, ii = Row() - 4; ii; i++, ii--)
                    ...
                    {
                        if(_ppA[i][j] == 0)
                            if(_ppA[i-2][j-2] || _ppA[i-2][j-1] || _ppA[i-2][j] || _ppA[i-2][j+1] || _ppA[i-2][j+2] ||
                               _ppA[i-1][j-2] || _ppA[i-1][j-1] || _ppA[i-1][j] || _ppA[i-1][j+1] || _ppA[i-1][j+2] ||
                               _ppA[i][j-2]   || _ppA[i][j-1]   ||              _ppA[i][j+1]   || _ppA[i][j+2]   ||
                               _ppA[i+1][j-2] || _ppA[i+1][j-1] || _ppA[i+1][j] || _ppA[i+1][j+1] || _ppA[i+1][j+2] ||
                               _ppA[i+2][j-2] || _ppA[i+2][j-1] || _ppA[i+2][j] || _ppA[i+2][j+1] || _ppA[i+2][j+2])
            ...
            {
                for(int i = 2, ii = Row() - 3; ii; i++, ii--)
                    for(int j = 2, jj = Col() - 3; jj; j++, jj--)
                    {
                        if(_ppA[i][j])
                            if(_ppA[i-2][j-2] == 0 || _ppA[i-2][j-1] == 0 || _ppA[i-2][j] == 0 || _ppA[i-2][j+1] == 0 || _ppA[i-2][j+2] == 0 ||
                               _ppA[i-1][j-2] == 0 || _ppA[i-1][j-1] == 0 || _ppA[i-1][j] == 0 || _ppA[i-1][j+1] == 0 || _ppA[i-1][j+2] == 0 ||
                               _ppA[i][j-2] == 0   || _ppA[i][j-1] == 0   ||                 _ppA[i][j+1] == 0   || _ppA[i][j+2] == 0   ||
                               _ppA[i+1][j-2] == 0 || _ppA[i+1][j-1] == 0 || _ppA[i+1][j] == 0 || _ppA[i+1][j+1] == 0 || _ppA[i+1][j+2] == 0 ||
                               _ppA[i+2][j-2] == 0 || _ppA[i+2][j-1] == 0 || _ppA[i+2][j] == 0 || _ppA[i+2][j+1] == 0 || _ppA[i+2][j+2] == 0)
...
KImageGray KImageGray::BinaryErode(const int& nType, int maskSize)
{
    KImageGray igOut = *this;
